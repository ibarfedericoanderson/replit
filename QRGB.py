...
class MainMenu(BoxLayout):
    ...
    def load_qrgb(self, filechooser, selection, *args):
        if selection:
            try:
                ...
                # Añadir los datos decodificados
                content.add_widget(Label(
                    text="Datos decodificados:",
                    font_size='16sp',
                    size_hint_y=None,
                    height=30
                ))
                ...
                if data_red:
                    ...
                    content.add_widget(Label(
                        text="Capa Roja: No se pudo decodificar",
                        color=(1, 0.5, 0.5, 1),
                        size_hint_y=None,
                        height=30
                    ))
                ...
                if data_green:
                    ...
                    content.add_widget(Label(
                        text="Capa Verde: No se pudo decodificar",
                        color=(0.5, 1, 0.5, 1),
                        size_hint_y=None,
                        height=30
                    ))
                ...
                if data_blue:
                    ...
                    content.add_widget(Label(
                        text="Capa Azul: No se pudo decodificar",
                        color=(0.5, 0.5, 1, 1),
                        size_hint_y=None,
                        height=30
                    ))
                ...
                # Crear un popup para mostrar los resultados
                result_popup = Popup(
                ...
                back_button.bind(on_release=result_popup.dismiss)
                result_popup.open()
    ...
    def open_github(self, instance):
        webbrowser.open("https://github.com/ibarfedericoanderson/ScriptPythonAppQRGB")
